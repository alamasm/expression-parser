...
class InfixParser(private val operationPerformer: OperationPerformer) : Parser {


    override fun calculate(infixExpresssion: String): Double {
        val postfix = convertToPostfix(infixExpresssion)
        println(postfix)
